function clean2foggy_Cityscapes_nn(left_image_file_names,...
    ...
    camera_parameters_file_names, scattering_coefficient_method,...
...
for i = 1:number_of_images
    ...
    parameters_suffix_transmission = strcat('_transmittance_beta_',...
    ...
    % and save them.
    imwrite(I, fullfile(current_foggy_output_directory, I_name_with_extension));
